...
public class TreasureHuntActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   level=Integer.parseInt(intent.getStringExtra("level"));
        ...
        adapter=new BoomAdapter(level,mode,allBoomsCount,gv,this);
        minesnum = (TextView) findViewById(R.id.mineView4);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!grid.isShow()){
                    if(grid.isBoom()){
                        ...
                        values.put("mode", "Hunt");
                        values.put("Time", gameTime);
                        HelperActivity helpter = new HelperActivity(TreasureHuntActivity.this);
                    ...
                    grid.setIsShow(true);
                    if(adapter.isWin() || grid.isTreasure()){
                        mp_win.start();
                        stopGame();
